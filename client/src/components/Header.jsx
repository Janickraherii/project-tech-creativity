...
function Header() {
  return (
    <header className='border border-[#2BCCC0] rounded-b-3xl  h-20 flex flex-row sticky top-0 backdrop-blur-md bg-gradient-to-b from-transparent to-[rgba(43,204,192,0.5)]'>
