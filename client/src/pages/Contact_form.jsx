  ...
  return (
    ...
    <div className='flex flex-row space-x-6 w-full h-screen items-center'>
         <div className='flex flex-col w-1/2 mt-20'>
            <img src={logo} alt="image1" className='w-44 ml-6 m-6' /> 
            <p className='text-[#2BCCC0]'>Libérez l'humour numérique sans limites !</p>
            <img src={deco} alt="image1" className=' w-96 ml-0 m-6 mb-0' /> 
         </div>

    <form onSubmit={handleSubmit} className='w-1/2'>
        <div className='flex flex-col border border-[#2BCCC0] rounded-3xl text-center bg-[#2A2A2A] mr-10'>
