        ...
        <div className='flex flex-col mt-4 '>
          <div className='bg-[#2A2A2A] w-96 h-96 dropzone rounded-3xl border border-[#2BCCC0]' {...getRootProps()}>
                  ...
                  {isDragActive ? (
                    ...
                    <p className="text-center text-[#2BCCC0] items-center">Glisser votre image
                    ici</p>
                  )}
                  {selectedImage && (
                    <div>
                      <img src={selectedImage.preview} alt="Preview" className="mt-4 mx-auto" />
                      <p className="text-center mt-2 text-white">Nom du fichier: {selectedImage.file.name}</p>
                    </div>
                  )}
                  </div>
